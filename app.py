...
/* ===== SINGLE CHECKBOX ALIGNMENT RULE =====
   Old checkbox overrides were removed above. This targets only the warning
   checkbox and aligns the label visually with Streamlit's native square. */
div[data-testid="stCheckbox"]:has(input[aria-label="I feel dizzy, faint, confused, or sick"]) label {
    display: flex !important;
    align-items: center !important;
...
div[data-testid="stCheckbox"]:has(input[aria-label="I feel dizzy, faint, confused, or sick"]) label p {
    margin: 0 !important;
    padding: 0 !important;
    line-height: 1.2 !important;
    /* Tiny visual nudge: keep the native checkbox square fixed and raise only the label text. */
    transform: translateY(4px) !important;
}

/* Solid card surfaces. Streamlit renders st.container(border=True) with
   stVerticalBlockBorderWrapper. Fill the wrapper AND its content layer so
   the background photo cannot show through any bordered card. */
[data-testid="stMainBlockContainer"] div[data-testid="stVerticalBlockBorderWrapper"] {
...
[data-testid="stMainBlockContainer"] div[data-testid="stVerticalBlockBorderWrapper"] > div[data-testid="stVerticalBlock"],
[data-testid="stMainBlockContainer"] div[data-testid="stVerticalBlockBorderWrapper"] > div > div[data-testid="stVerticalBlock"] {
    background: #FFF9F0 !important;
    background-color: #FFF9F0 !important;
    background-image: none !important;
    opacity: 1 !important;
...
/* Final readability guard for muted helper text across the app. */
